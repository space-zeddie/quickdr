...
public class PatientController {
    ...
    public String create(String name, int age, String diagnosis) {
        ...
        try {
            ...
            return HEADER +  "Error registering the partient: " + ex.toString() + FOOTER;
        }
        return HEADER + "Patient succesfully registered with id = " + patientId + FOOTER;
    }
    ...
    public String delete(int id) {
        try {
            ...
            return HEADER + "Error deleting the patient:" + ex.toString() + FOOTER;
        }
        return HEADER + "Patient succesfully deleted!" + FOOTER;
    }
    ...
    public String updateSubject(int id, String name, int age, String diagnosis) {
        try {
            ...
            return HEADER + "Error updating the patient: " + ex.toString() + FOOTER;
        }
        return HEADER + "Patient succesfully updated!" + FOOTER;
    }
